...
public class NumUpDown extends JTextField implements MouseListener, MouseMotionListener, DocumentListener
{
	...
	public void setMin(int value)
	{
		if (type == TYPE_INT && value < maxInt)
			minInt = value;
		else if (type == TYPE_FLOAT && value < maxFloat)
			minFloat = value;
		else if (type == TYPE_DOUBLE && value < maxDouble)
			minDouble = value;
	}
	...
	public void setMax(int value)
	{
		if (type == TYPE_INT && value > minInt)
			maxInt = value;
		else if (type == TYPE_FLOAT && value > minFloat)
			maxFloat = value;
		else if (type == TYPE_DOUBLE && value > minDouble)
			maxDouble = value;
	}
